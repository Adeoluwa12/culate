...
router.post('/dashboard/finalconvert', async (req, res) => {
  ...
  try {
    ...
    const response = await fetch(`https://v6.exchangerate-api.com/v6/e2bb2601faef88b3fe389f57/latest/${selectedCurrency}`);
...
router.post('/dashboard/autoconvert', async (req, res) => {
  ...
  try {
    const response = await fetch(`https://v6.exchangerate-api.com/v6/e2bb2601faef88b3fe389f57/latest/NGN`);
    const data = await response.json();
...
router.post('/dashboard/autofinalconvert', async (req, res) => {
  ...
  try {
    ...
    const ngnResponse = await fetch(`https://v6.exchangerate-api.com/v6/e2bb2601faef88b3fe389f57/latest/NGN`);
